fn main() {
    ...
    // you can use match or if let to extract and use those values, depending on how many
    // cases you need to handle.
    // Your Rust programs can now express concepts in your domain using structs and enums.
    // Creating custom types to use in your API ensures type safety: the compiler will
    // make certain your functions only get values of the type each function expects.
